...
public class DEBUGBossDialogueParser : MonoBehaviour
{
    ...
    private void ProceedToNarrative(string narrativeDataGUID)
    {
        ...
        //For Debug Start
        string attackString= "";
        foreach (KeyValuePair<string, Attack_Stats> attack in Boss.GetComponent<GoblinBossStats>().attacks)
        {
            attackString += "\n" + attack.Key + ": " + attack.Value.ToString();
        }
